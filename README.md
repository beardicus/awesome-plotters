...
- [Orbis Tertius, an immersive digital installation about the planet Mars cartography, and the long data travel from Mars surface up to its on-site generative render](http://www.glkitty.com/pages/orbistertius.html)
